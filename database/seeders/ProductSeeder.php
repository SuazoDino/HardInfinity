    ...
    public function run(): void
    {
        ...
        $products = [
            [
                ...
                'is_featured' => true,
                'specifications' => [
                    ['name' => 'Núcleos', 'value' => '16'],
                    ['name' => 'Hilos', 'value' => '32'],
                    ['name' => 'Frecuencia Base', 'value' => '4.5 GHz'],
                    ['name' => 'Frecuencia Turbo', 'value' => '5.7 GHz'],
                    ['name' => 'Socket', 'value' => 'AM5'],
                    ['name' => 'Caché L3', 'value' => '64 MB'],
                    ['name' => 'TDP', 'value' => '170W'],
                ],
            ],
            [
                ...
                'specifications' => [
                    ...
                    ['name' => 'Hilos', 'value' => '32'],
                    ['name' => 'Frecuencia Base', 'value' => '3.0 GHz'],
                    ['name' => 'Frecuencia Turbo', 'value' => '5.8 GHz'],
                    ['name' => 'Socket', 'value' => 'LGA1700'],
                    ['name' => 'Caché L3', 'value' => '36 MB'],
                    ['name' => 'TDP', 'value' => '125W (253W Turbo)'],
                ],
            ],
            [
                ...
                'specifications' => [
                    ...
                    ['name' => 'Memoria', 'value' => '24 GB GDDR6X'],
                    ['name' => 'Bus de Memoria', 'value' => '384-bit'],
                    ['name' => 'Clock Base', 'value' => '2.23 GHz'],
                    ['name' => 'Clock Boost', 'value' => '2.52 GHz'],
                    ['name' => 'TDP', 'value' => '450W'],
                ],
            ],
            [
                ...
                'is_featured' => false,
                'specifications' => [
                    ['name' => 'Capacidad', 'value' => '32 GB (2x16GB)'],
                    ['name' => 'Tipo', 'value' => 'DDR5'],
                    ['name' => 'Frecuencia', 'value' => '6000 MHz'],
                    ['name' => 'Latencia', 'value' => 'CL36'],
                    ['name' => 'Voltaje', 'value' => '1.35V'],
                    ['name' => 'RGB', 'value' => 'No'],
                ],
            ],
            [
                ...
                'is_featured' => true,
                'specifications' => [
                    ['name' => 'Capacidad', 'value' => '2 TB'],
                    ['name' => 'Factor de Forma', 'value' => 'M.2 2280'],
                    ['name' => 'Interfaz', 'value' => 'PCIe 4.0 x4 NVMe'],
                    ['name' => 'Lectura Secuencial', 'value' => '7,450 MB/s'],
                    ['name' => 'Escritura Secuencial', 'value' => '6,900 MB/s'],
                    ['name' => 'MTBF', 'value' => '1.5M horas'],
                ],
            ],
        ];
